...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_DIGEE_MD_ENCODER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_TICKS_PER_SEC, 100000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MCMD_STM32_G0B1CC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MCMD_STM32_G0B1CC_STM32G0B1XX, 1);
